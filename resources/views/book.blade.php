          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                  <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                      Aqui puedes crear un nuevo Libro
                  </h3>
              ...
              <div class="p-6 space-y-6">
                <div class="mb-6">
                    <label for="provider_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Id Proveedor</label>
                    <input type="text" id="provider_id" name="provider_id" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="name@flowbite.com" required>
                  </div>
                <div class="mb-6">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="px-6 py-4">
                    <a href="{{route('book.view',$book['id'])}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Actualizar Book</a>
                </td>
                <td class="px-6 py-4">
                    <a href="{{route('book.delete',$book['id'])}}" class="font-medium text-red-600 dark:text-blue-500 hover:underline">Delete Book</a>
                </td>
            </tr>
            @endforeach
        </tbody>
